...
## Credit
Adobe Premiere CC program for video editing capabilities. Various media conversion websites needed when editing the video. Geojson for creating a program that makes geojsons. Google for finding information. Font Awesome and Flaticon for making useable icons. Most of the credit is in ***data Source**.
